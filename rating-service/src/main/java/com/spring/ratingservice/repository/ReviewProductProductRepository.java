...
public interface ReviewProductProductRepository extends JpaRepository<ReviewProduct, Long>, JpaSpecificationExecutor<ReviewProduct> {
    ...
    @Query("""
                   SELECT
                        new com.spring.ratingservice.domain.ProductReviewDTO(
                              tb1.productId,
                              SUM(tb1.count),
            ...
            """)
    Optional<ProductReviewDTO> findProductReviewDTOByProductId(@Param("productId") String productId);
    ...
    @Query("""
                   ...
                   GROUP BY tb1.productId
            """)
    List<ProductReviewDTO> findProductReviewDTOByProductIds(@Param("productIds") Set<String> productIds);
}
